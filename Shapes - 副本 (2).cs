        ...
        public class Dot : IShape
        {
            ...
            public void Delete()
            {
             ...
             //   foreach(var l in this.Lines)
                ...
                foreach (RemAngle angle in this.Canvas.Shapes.Where(s => s.ShapeType == ShapeType.RemAngle))
                {
                    if (angle.Dot == this)
                    {
                        angle.Delete();
                ...
                foreach (FillArea fillArea in this.Canvas.Shapes.Where(s => s.ShapeType == ShapeType.FillArea))
                {
