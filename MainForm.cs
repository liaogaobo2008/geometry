...
namespace Riches.Visio
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            colorList.Add("255,128,128");
            colorList.Add("255,255,128");
            colorList.Add("128,255,128");
            colorList.Add("0,255,128");
            colorList.Add("128,255,255");
            colorList.Add("0,128,255");
            colorList.Add("255,128,192");
            colorList.Add("255,128,255");
            colorList.Add("255,0,0");
            colorList.Add("255,255,0");
            colorList.Add("128,255,0");
            colorList.Add("0,255,64");
            colorList.Add("0,255,255");
            colorList.Add("0,128,192");
            colorList.Add("128,128,192");
            colorList.Add("255,0,255");
            colorList.Add("128,64,64");
            colorList.Add("255,128,64");
            colorList.Add("0,255,0");
            colorList.Add("0,128,128");
            colorList.Add("0,64,128");
            colorList.Add("128,128,255");
            colorList.Add("128,0,64");
            colorList.Add("255,0,128");
            colorList.Add("128,0,0");
            colorList.Add("255,128,0");
            colorList.Add("0,128,0");
            colorList.Add("0,128,64");
            colorList.Add("0,0,255");
            colorList.Add("0,0,160");
            colorList.Add("128,0,128");
            colorList.Add("128,0,255");
            colorList.Add("64,0,0");
            colorList.Add("128,64,0");
            colorList.Add("0,64,0");
            colorList.Add("0,64,64");
            colorList.Add("0,0,128");
            colorList.Add("0,0,64");
            colorList.Add("64,64,0");
            colorList.Add("64,0,128");

            foreach (var c in colorList)
            {
                var cs = c.Split(',');
                Color color = Color.FromArgb(Convert.ToInt32(cs[0]), Convert.ToInt32(cs[1]), Convert.ToInt32(cs[2]));

                var item = new ToolStripMenuItem() { Name = color.ToString(), Text = "" };
            ...
            //    var item = new ToolStripMenuItem() { Name = color.ToString(), Text = color.ToString() };
            //    item.Click += ColorMenuitem_Click;
            //    item.Tag = color;
            //    item.BackColor = color;
            //    item.Height = 15;
        ...
        public MDIChildForm CreateMdiChild()
        {
            ...
            RefreshItemForm(mdiChild);
            return mdiChild;
        }

        private void RefreshItemForm(MDIChildForm child)
        {
        ...
        private void ItemForm_Click(object sender, EventArgs e)
        {
            ...
            child.Activate();
            RefreshItemForm(child);
        }

        private void MdiChild_OnMyMouseMove(object sender, MouseEventArgs e)
        {
            this.toolStripStatusLabelMoueXY.Text = String.Format("x={0:D4},y={1:D4}", e.X, e.Y);
        }
        ...
        private void MainForm_MdiChildActivate(object sender, EventArgs e)
        {
            ...
            this.显示坐标值ToolStripMenuItem.Checked = child.canvasHelper.IsDisplayXYCoord;
        }
        ...
        private void OpenFile()
        {
            ...
            if (openFileDialog.ShowDialog() == DialogResult.OK)
            {
                      ...
                      || 最近文件ToolStripMenuItem.DropDownItems.Count==0)
                {
                    ...
                    最近文件ToolStripMenuItem.DropDownItems.Insert(0, item);
        ...
        {
            {
                foreach (ToolStripMenuItem item in 窗口ToolStripMenuItem.DropDownItems)
                {
                    ...
                    {
                        var form = item.Tag as MDIChildForm;
                        form.Activate();
                        return;
                    }
                }
        ...
        private void 角度ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (child == null)
                return;
          //  child.canvasHelper.RemoAngle();
        }

        private void 填充封闭区间ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var child = this.ActiveMdiChild as MDIChildForm;
            if (child == null)
                return;
           // child.canvasHelper.FillArea();
        }

      

        private void 显示坐标值ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            var child = this.ActiveMdiChild as MDIChildForm;
            if (child == null)
                return;
            this.显示坐标值ToolStripMenuItem.Checked = !this.显示坐标值ToolStripMenuItem.Checked;
            child.canvasHelper.IsDisplayXYCoord = this.显示坐标值ToolStripMenuItem.Checked;
